            ...
            <div className="flex flex-col gap-4 md:flex-[2_2_0%]">
              <Link to="/">
                <div className="font-extrabold flex flex-row gap-2">
                  ...
                  <h1 className="text-xl text-black">Brew91.</h1>
                </div>
              </Link>
              <div className="md:w-96">
                Brew91 is a store that sells some good meals, and especially
              ...
              <div className="copyright">(c) 2024 Brew91 Mayank Sangwan</div>
            </div>
